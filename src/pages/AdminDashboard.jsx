    ...
    <div className="max-w-6xl mx-auto py-12 px-4 animate-in fade-in duration-500 relative">
      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-gray-500 mt-2">Review AI decisions and apply human adjuster overrides when necessary.</p>
        </div>
          ...
          <div className="bg-white rounded-3xl w-full max-w-lg overflow-hidden premium-shadow max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-6 space-y-6">
              ...
              <div>
                ...
                >
                  <option value="">Select model classification...</option>
                  <optgroup label="Vehicle Damage">
                    <option value="vehicle_dent">Vehicle Dent</option>
                    <option value="bumper_damage">Bumper Damage</option>
                    <option value="glass_damage">Glass Damage</option>
                    <option value="light_damage">Light Damage</option>
                    <option value="mirror_damage">Mirror Damage</option>
                    <option value="runningboard_damage">Runningboard Damage</option>
                  </optgroup>
